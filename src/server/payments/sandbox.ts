 ...
 * For the sandbox, that callback is `resolve()` below instead of a
 * provider's webhook — the client-facing "pay" step (Phase 1.4b) calls
 * it directly, standing in for a real gateway's redirect-back or push
 * notification.
 */
