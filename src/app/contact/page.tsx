    ...
    <main className="contact-page" id="main-content">
      <div className="page-intro">
        <FadeIn>
          ...
          <h1 className="contact-page__title">Ask us anything.</h1>
      ...
      <FadeIn>
        <section className="contact-form-wrap" aria-label="Send a message">
          {sent ? (
            <div className="contact-page__sent" role="status" aria-live="polite">
              <span className="label" style={{ color: 'var(--gold-text)' }}>Sent</span>
              <h2 className="contact-page__sent-title">Thank you, {form.name}.</h2>
              <p className="contact-page__sent-body">
            ...
            <form className="contact-form" onSubmit={submit} noValidate aria-label="Contact form">
              <div className="field">
                ...
                />
                {errors.name && <span id="c-name-err" className="field__error" role="alert">{errors.name}</span>}
              </div>

              <div className="field-row">
                <div className="field">
                  <label className="field__label" htmlFor="c-phone">Phone</label>
                  <input
                    id="c-phone"
                    name="phone"
                  ...
                  />
                  {errors.phone && <span id="c-phone-err" className="field__error" role="alert">{errors.phone}</span>}
                </div>
              ...
              <div className="field">
                <label className="field__label" htmlFor="c-subject">What is it about</label>
                <select
                  id="c-subject"
                  name="subject"
                  className="field__input"
              ...
              <div className="field">
                ...
                />
                {errors.message && <span id="c-message-err" className="field__error" role="alert">{errors.message}</span>}
              </div>
          ...
          <aside className="contact-aside">
            <div className="contact-block">
              ...
              <p className="contact-block__text">
                ...
                <br />
                <span style={{ color: 'var(--ink-meta)' }}>{SITE_CONFIG.hours.note}</span>
              </p>
            </div>
            ...
            <div className="contact-block">
              ...
              <div style={{ marginTop: '16px' }}>
                <Link className="tlink" href="/book">Book a chair →</Link>
              </div>
            </div>
