...
export default function AccountPage() {
  return (
    ...
    >
      <div
        className="wrap sec--tight stack"
      ...
      >
        ...
        >
          <div>
            <p className="label">Design preview · Sample account</p>
        ...
        <div
          className="rule-grid"
          style={{ border: "1px solid var(--s-rule)" }}
        >
          <div
          ...
          >
            ...
            <span className="data--lg" style={{ fontSize: 42, lineHeight: 1 }}>
              06
            </span>
            <span className="meta">Ten Half Hours · expires 12 Nov 2026</span>
            <div
              style={{ height: 4, background: "var(--s-rule-2)", marginTop: 6 }}
            >
              <div
                style={{ width: "60%", height: 4, background: "var(--gold)" }}
              />
            </div>
          </div>
          <div
          ...
          >
            ...
            <span
              className="data--lg"
              style={{ fontSize: 30, color: "var(--s-ink)" }}
            >
              THU 18:30
            </span>
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 6 }}>
              ...
              <span className="meta">Sample reservation</span>
            </div>
          </div>
          <div
            className="stack--tight"
          ...
          >
            ...
            <span className="meta">
              Held for your visits while the pack runs.
            </span>
          </div>
        </div>
        ...
        <div className="rail">
          <div className="rail__body" style={{ flex: "1 1 420px" }}>
            ...
            {VISITS.map((v) => (
              <div
                key={v.when}
                style={{
                  borderTop: "1px solid var(--s-rule)",
                  padding: "16px 0",
                  display: "flex",
                  flexWrap: "wrap",
                  gap: "10px 20px",
              ...
              >
                <span className="data" style={{ color: "var(--s-meta)" }}>
                  {v.when}
                </span>
                <span
                  className="h3"
                ...
                <span className="data" style={{ color: "var(--s-body)" }}>
                  {v.note}
                </span>
              </div>
            ))}
          ...
          >
            ...
            <h2
              className="h3"
              style={{ fontFamily: "var(--font-serif)", fontSize: 27 }}
            >
              Six sessions left of ten.
            </h2>
            <p className="meta">
              Buy the next pack before this one expires and the remaining
